  ...
  async function initChat(token, username) {
    ...
    function makeWsController() {
      ...
      async function connectWs() {
        // #region agent log
        fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H2',location:'bookmarklet.js:connectWs:entry',message:'connectWs invoked',data:{wsActive,wsPaused,controllerRoom,currentRoom,hasWs:!!ws},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        ...
        try {
          ...
          ws.addEventListener("close", () => {
            // #region agent log
            fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H2',location:'bookmarklet.js:connectWs:onclose',message:'websocket closed',data:{wsActive,wsPaused,controllerRoom,currentRoom},timestamp:Date.now()})}).catch(()=>{});
            // #endregion
            updateWsIndicator(false); if (wsActive && !wsPaused) scheduleReconnect();
          });
      ...
      function handleIncomingChatMessage(msg) {
        // #region agent log
        fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H1',location:'bookmarklet.js:handleIncomingChatMessage:entry',message:'incoming chat message for render',data:{controllerRoom,currentRoom,msgType:msg&&msg.type,from:msg&&msg.username,textPreview:String((msg&&msg.text)||'').slice(0,20)},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
      ...
      async function slowPoll() {
        // #region agent log
        fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H1',location:'bookmarklet.js:slowPoll:entry',message:'slow poll fired',data:{controllerRoom,currentRoom,wsActive,wsPaused,lastCount},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        if (!wsActive || wsPaused) return;
        try {
      ...
      function handleCallSignal(msg) {
        // #region agent log
        fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H5',location:'bookmarklet.js:handleCallSignal:entry',message:'call signal received',data:{signalType:msg&&msg.type,from:msg&&msg._from,isGroupCall,callState,callPeer},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        switch (msg.type) {
          case "call-offer":
      ...
      async function startCall(targetUsername) {
        ...
        try {
          ...
          // #region agent log
          fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H3',location:'bookmarklet.js:startCall:getUserMediaSuccess',message:'1to1 local stream acquired',data:{audioTracks:_localStream?_localStream.getAudioTracks().length:0,videoTracks:_localStream?_localStream.getVideoTracks().length:0},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
          ...
          // #region agent log
          fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H3',location:'bookmarklet.js:startCall:getUserMediaOrOfferError',message:'1to1 start call failed',data:{error:e&&e.message?e.message:String(e)},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
          console.error("startCall error", e); endCall("error");
        }
      }
      ...
      function createPeerConnection(targetUsername) {
        ...
        pc.oniceconnectionstatechange = () => {
          ...
          // #region agent log
          fetch('http://127.0.0.1:7429/ingest/4c92d377-2c94-4c80-bc80-ccbec9415c27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9bf524'},body:JSON.stringify({sessionId:'9bf524',runId:debugRunId,hypothesisId:'H4',location:'bookmarklet.js:createPeerConnection:oniceconnectionstatechange',message:'ice state changed',data:{targetUsername,state:s,isGroupCall,callState},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
          if (!isGroupCall) {
